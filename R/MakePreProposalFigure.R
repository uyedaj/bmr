...
addColorBar <- function(x, y, height, width, pal, trait, ticks, adjx=0, n=100,cex.lab=1,pos=2){
  ...
  text(x+adjx, y=seq(y, y+height, length.out=length(ticks)), labels=ticklab, pos=pos,cex=cex.lab)
}
...
require(wesanderson)
pdf("../doc/preproposal/figures/slopeintfig.pdf",width=12, height=10)
cex.circle <- 2.5
...
addColorBar(x=40, y=0, height=400, width=20, pal=pal, trait=allbranches[,1], ticks=seq(-2,2,1),adjx=2, cex.lab=2)
text(0,length(tree$tip.label), "Intercept", pos=4, cex=2.5)
...
addColorBar(x=454, y=0, height=400, width=20, pal=pal, trait=allbranches[,2], ticks=seq(0.68,0.8,length.out=5),adjx=5,cex.lab=2)
text(350,length(tree$tip.label), "Slope", pos=4,cex=2.5)
nodelabels(text="III", node=tree$edge[1703,2], bg = "white",frame="circle",cex=cex.circle)
nodelabels(text="II", node=tree$edge[578,2], bg = "white",frame="circle",cex=cex.circle)
nodelabels(text="I", node=tree$edge[344,2], bg = "white",frame="circle",cex=cex.circle)
dev.off()
...
pdf("../doc/preproposal/figures/allometryfig.pdf",width=6.5, height=10)
{
...
rasterImage(imSal,-1,Ylim[2]-3.5,2,Ylim[2]-1.5, col="green")
...
rasterImage(imSnake,-1,Ylim[2]-4.25,2,Ylim[2]-1.25, col="green")
...
rasterImage(imMamm,-1,Ylim[2]-4.25,2,Ylim[2]-1.25, col="green")
