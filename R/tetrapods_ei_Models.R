...
## Proposal widths
D.XXX <- function(nrj) list(alpha=0.7, sig2= 0.5, beta_lnMass=0.1, beta_lnMass2=0.004, beta_lnGS=0.2, beta_endo=0.5, k=rep(1,nrj), theta=3, slide=1, missing.pred=1)
D.1XX <- function(nrj) list(alpha=0.7, sig2= 0.5, beta_lnMass=0.1, beta_lnMass2=0.004, beta_lnGS=0.2, beta_endo=0.5, k=rep(1,nrj), theta=0.15, slide=1, missing.pred=1)
D.XNX <- function(nrj) list(alpha=0.7, sig2= 0.5, beta_lnMass=0.2, beta_lnMass2=0.004, beta_lnGS=0.2, beta_endo=0.5, k=rep(1,nrj), theta=1, slide=1, missing.pred=1)
...
model.11010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = numeric(0), cache, prior.11010, impute = c("lnGS"), D=D.XNX(1))
...
model.11011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = numeric(0), cache, prior.11011, impute = c("lnGS"), D=D.XNX(1))
...
model.N1010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = c("theta"), cache, prior.N1010, impute = c("lnGS"), D=D.XNX(1))
...
model.NN010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = c("theta", "lnMass"), cache, prior.NN010, impute = c("lnGS"), D=D.XNX(2))
...
model.N1011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = c("theta"), cache, prior.N1011, impute = c("lnGS"), D=D.XNX(1))
...
model.NN011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = c("theta", "lnMass"), cache, prior.NN011, impute = c("lnGS"), D=D.XNX(2))
...
model.S1010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = c("theta"), cache, prior.S1010, impute = c("lnGS"), D=D.XNX(1))
...
model.SS010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = c("theta", "lnMass"), cache, prior.SS010, impute = c("lnGS"), D=D.XNX(2))
...
model.S1011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = c("theta"), cache, prior.S1011, impute = c("lnGS"), D=D.XNX(1))
...
model.SS011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = c("theta", "lnMass"), cache, prior.SS011, impute = c("lnGS"), D=D.XNX(2))
...
model.P1010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = c("theta"), cache, prior.P1010, impute = c("lnGS"), D=D.XNX(1))
...
model.PP010 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo, rjpars = c("theta", "lnMass"), cache, prior.PP010, impute = c("lnGS"), D=D.XNX(2))
...
model.P1011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = c("theta"), cache, prior.P1011, impute = c("lnGS"), D=D.XNX(1))
...
model.PP011 <- makeBayouModel(lnBMR ~ lnMass + lnGS + endo + lnGS*lnMass, rjpars = c("theta", "lnMass"), cache, prior.PP011, impute = c("lnGS"), D=D.XNX(2))
